	...
	DescribeTable(
		...
		Entry(
			...
			expectReport(
				...
				``,
				`  | EXPLANATION`,
				`  |     Fail() called at satisfy_test.go:61`,
			),
		),
		Entry(
			...
			expectReport(
				...
				``,
				`  | EXPLANATION`,
				`  |     SkipNow() called at satisfy_test.go:74`,
			),
		),
		Entry(
		...
		Entry(
			...
			expectReport(
				...
				``,
				`  | EXPLANATION`,
				`  |     Error() called at satisfy_test.go:113`,
				`  | `,
				`  | LOG MESSAGES`,
				`  |     <message>`,
			),
		...
		Entry(
			...
			expectReport(
				...
				``,
				`  | EXPLANATION`,
				`  |     Errorf() called at satisfy_test.go:129`,
				`  | `,
				`  | LOG MESSAGES`,
				`  |     <format value>`,
			),
		...
		Entry(
			...
			expectReport(
				...
				``,
				`  | EXPLANATION`,
				`  |     Fatal() called at satisfy_test.go:145`,
				`  | `,
				`  | LOG MESSAGES`,
				`  |     <message>`,
			),
		...
		Entry(
			...
			expectReport(
				...
				``,
				`  | EXPLANATION`,
				`  |     Fatalf() called at satisfy_test.go:161`,
				`  | `,
				`  | LOG MESSAGES`,
				`  |     <format value>`,
			),
		...
		Entry(
			...
			expectReport(
				...
				``,
				`  | EXPLANATION`,
				`  |     Fail() called indirectly by call at satisfy_test.go:182`,
			),
		),
		Entry(
			...
			expectReport(
				...
				``,
				`  | EXPLANATION`,
				`  |     Fail() called at satisfy_test.go:196`,
			),
		),
		Entry(
			...
			expectReport(
				...
				``,
				`  | EXPLANATION`,
				`  |     Fail() called indirectly by call at satisfy_test.go:216`,
			),
		),
	)
